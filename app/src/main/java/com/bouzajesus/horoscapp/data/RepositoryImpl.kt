...
class RepositoryImpl @Inject constructor(private val apiService: HoroscopeApiService) : Repository {
    ...
    override fun getRandomLuckyModel(): LuckyModel? {
        val predictionsAmount = 32
        val randomPrediction = Random.nextInt(0, predictionsAmount)

        return when(randomPrediction){
